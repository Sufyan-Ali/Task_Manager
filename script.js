...
const displayCompletedTasksElement = document.getElementById(
  "displayCompletedTasks",
);
const displayPendingTasksElement = document.getElementById(
  "displayPendingTasks",
);
const displayAllCategoriesElement =
  document.getElementById("displayAllCategory");
const displayStudyCategoryElement = document.getElementById(
  "displayStudyCategory",
);
const displayWorkCategoryElement = document.getElementById(
  "displayWorkCategory",
);
const displayPersonalCategoryElement = document.getElementById(
  "displayPersonalCategory",
);
...
displayPersonalCategoryElement.addEventListener(
  "click",
  displayPersonalCategory,
);
...
function taskCounter() {
  ...
  tasks.reduce((result, currentValue) => {
  ...
  totalTaskCount.innerHTML = `Total Tasks: ${result.total}`;
  completedTaskCount.innerHTML = `Completed Tasks: ${result.completed}`;
  pendingTaskCount.innerHTML = `Pending Tasks: ${result.pending}`;
